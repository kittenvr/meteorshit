...
public class BlacklistedPerson implements ISerializable<BlacklistedPerson>, Comparable<BlacklistedPerson> {
    ...
    public BlacklistedPerson(PlayerEntity player) {
    ...
    @Override
    public BlacklistedPerson fromTag(NbtCompound tag) {
        return this;
    }
    ...
    @Override
    public int compareTo(@NotNull BlacklistedPerson blacklistedPerson) {
